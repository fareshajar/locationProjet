        ...
        const handleSubmit = async (event) => {
            ...
            try {
                ...
                if (editionMode && reservationEnEdition) {
                    ...
                    console.log("reservation a ajouter",reservationData)
            ...
            return (
                <div className="modal">
                    <div className="modal-content">
                        ...
                        <button onClick={onClose} className="print-ferme">Fermer</button>
                    </div>
                </div>
            );
        };
    ...
    `);
                    ...
                    <div className="modal-content">
                        ...
                        {details ? (
                            <div>
                                ...
                                <p><strong>Animaux admis:</strong> {details.reservation.animauxAdmis ? 'Oui' : 'Non'}
                                </p>
        ...
        return (
            <div className="container">
                ...
                {showDetailsModal && (
                    < InvoiceModal details={reservationDetails} onClose={() => setShowDetailsModal(false)}/>
                )}
            </div>
        );
    }
